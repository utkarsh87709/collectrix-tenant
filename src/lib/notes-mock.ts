...
export const builtInTemplates: NoteTemplate[] = [
  ...
  },
  {
    ...
    icon: "CV",
    description: "Detailed log of a debtor conversation.",
    defaultVisibility: "creditor",
    isBuiltIn: true,
    fields: [
      ...
      { key: "debtor_statements", label: "Debtor statements", type: "textarea", required: false },
  ...
  },
  {
    ...
    icon: "LN",
    description: "Track a legal notice sent to the debtor.",
    defaultVisibility: "creditor",
    isBuiltIn: true,
    fields: [
  ...
  },
  {
    ...
    category: "dispute",
    icon: "DS",
    description: "Capture a debtor dispute and investigation status.",
    defaultVisibility: "internal",
    isBuiltIn: true,
    fields: [
      ...
      { key: "claims", label: "Debtor claims", type: "textarea", required: true },
  ...
  return [
    {
      ...
      category: "contact_attempt",
      title: "Reached debtor on mobile — committed to call back",
      fields: { phone: "+1 (416) 555-0142", outcome: "Connected", next_action: "Debtor will call back Friday at 2pm with payment proposal." },
      bodyHtml: "<p>Spoke with debtor for ~6 minutes. Tone cooperative. Acknowledged balance and indicated willingness to set up a payment plan once paycheck arrives Thursday.</p>",
      visibility: "creditor",
      pinned: false,
      attachments: [],
      links: [],
    ...
    },
    {
      ...
      bodyHtml: "<p>Debtor agreed to a 6-month plan starting May 1. ACH authorization on file.</p>",
      visibility: "creditor",
      pinned: false,
      attachments: [],
      links: [],
