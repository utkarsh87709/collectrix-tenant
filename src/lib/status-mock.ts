...
const RAW: Omit<StatusCode, "custom">[] = [
  ...
  { code: "PTP",  displayName: "Promised To Pay",           description: "Debtor committed to a payment date",                 tone: "info",    icon: "PTP",  category: "collection", isFinal: false, requiresApproval: false, countsAsActive: true,  allowedNext: ["PPD", "PIF", "BRP", "REV"] },
  { code: "BRP",  displayName: "Broken Promise",            description: "Debtor failed to honor a promise to pay",            tone: "warning", icon: "BRP",  category: "collection", isFinal: false, requiresApproval: false, countsAsActive: true,  allowedNext: ["ACT", "PTP", "PPA", "REV"] },
  { code: "PIF",  displayName: "Promised Paid In Full",     description: "Debtor committed to full payoff",                    tone: "info",    icon: "PIF",  category: "collection", isFinal: false, requiresApproval: false, countsAsActive: true,  allowedNext: ["CLO", "REV"] },
  ...
  { code: "RTP",  displayName: "Refuse To Pay",             description: "Debtor refuses payment",                             tone: "danger",  icon: "RTP",  category: "risk",       isFinal: false, requiresApproval: false, countsAsActive: true,  allowedNext: ["REV"] },
  { code: "DNC",  displayName: "Do Not Contact",            description: "Debtor invoked do-not-contact",                      tone: "danger",  icon: "DNC",  category: "risk",       isFinal: false, requiresApproval: true,  countsAsActive: false, allowedNext: ["REV"] },
  ...
  { code: "WEL",  displayName: "Welfare",                   description: "Debtor on welfare — hardship",                       tone: "muted",   icon: "WEL",  category: "review",     isFinal: false, requiresApproval: false, countsAsActive: false, allowedNext: ["CLO"] },
  { code: "UIC",  displayName: "Unemployed",                description: "Debtor unemployed — hardship",                       tone: "muted",   icon: "UIC",  category: "review",     isFinal: false, requiresApproval: false, countsAsActive: false, allowedNext: ["CLO"] },
  ...
  { code: "JDG",  displayName: "Judgement Obtained",        description: "Judgement obtained against debtor",                  tone: "legal",   icon: "JDG",  category: "legal",      isFinal: false, requiresApproval: true,  countsAsActive: true,  allowedNext: ["POS", "WRIT", "GAR"] },
...
export const sampleStatusHistory: StatusEvent[] = [
  ...
  { id: "se-3", when: "Mar 15, 2026 14:38", fromStatus: "ACT", toStatus: "PTP", actor: "John Park",    isSystem: false, reason: "Debtor agreed to pay $500 by Mar 25" },
